...
def ImportMainBootloaderFirmware(info):
  info.script.AppendExtra('ui_print("Flashing miui_HM4AGlobal_V9.6.5.0.NCCMIFD Firmware.");')
...
def ImportBkpBootloaderFirmware(info):
  info.script.AppendExtra('ui_print("Flashing Backup miui_HM4AGlobal_V9.6.5.0.NCCMIFD Firmware.");')
